...
class ExperimentCampaign(Base):
    ...
    baseline_run_id: Mapped[int | None] = mapped_column(Integer)
    baseline_snapshot_sha256: Mapped[str | None] = mapped_column(String(64))
    baseline_snapshot: Mapped[dict[str, object] | None] = mapped_column(ContentFreeExperimentJSON("baseline_snapshot"))
